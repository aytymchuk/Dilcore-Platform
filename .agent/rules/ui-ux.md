---
trigger: glob
globs: src/Web/WebApp/**/*
---

# UI/UX: Modern MudBlazor Design

This document provides guidelines and best practices for creating a "Premium", "Modern", and "AI-Driven" user experience using the MudBlazor framework for the SaaS NoCode Platform.
